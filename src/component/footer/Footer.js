...
const Footer = ({navigation}) => {
    ...
    return (
        <View style={styles.container}>
            <ImageButton onPress={() => navigation.navigate('PreVisualizacion')} icon={'https://cdn.icon-icons.com/icons2/2098/PNG/512/list_icon_128825.png'}></ImageButton>
            <ImageButton onPress={() => navigation.navigate('Localitation')} icon={'https://cdn.icon-icons.com/icons2/38/PNG/512/star_favorite_5754.png'}></ImageButton>
